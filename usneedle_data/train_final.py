...
shutil.rmtree('./informer_checkpoints/IP')

os.mkdir('./informer_checkpoints/IP')

shutil.rmtree('./informer_checkpoints/OOP')

os.mkdir('./informer_checkpoints/OOP')    
...
originPath = args.root_path
origin_checkpoint_path = args.checkpoints
#IPdata_train_parser = IPdata_train_parser + IPdata_val_parser
...
for participant in IPdata_test_parser:
    ...
    #args.data_path = data_info['data']
        ...
        exp.test(setting,'IP/' + args.data_path)
        print("done testing")
